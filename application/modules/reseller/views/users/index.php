        ...
        <div class="panel panel-flat">
          <div class="panel-heading">
            ...
            <div style="display: none;" class="actiontools">
                  ...
                  <a href="<?= site_url('reseller/users/index?status=active'); ?>" class="btn btn-default text-success <?php if(!empty($q) && $q=='active') {?>active <?php } ?>  btn-sm"> ACTIVE (<?= $active_users->num_rows(); ?>) </a>
               
                  <a href="<?= site_url('reseller/users/index?status=expired'); ?>" class="btn btn-default text-danger <?php if(!empty($q) && $q=='expired') {?>active <?php } ?> btn-sm"> EXPIRED (<?= $expired_users->num_rows(); ?>) </a>
                </div>
                    </div>
          </div>
           ...
           <table class="table table-bordered table-striped datatable-responsive">
            ...
            <tbody>
              ...
              <tr class="odd gradeX">
                <td><?=$row->account;?></td>
                <td class="text-center"><a href="<?= site_url('reseller/users/edit/'.$row->account); ?>"><?php if(empty($row->mac)) { $this->stalker_model->mac_update($row->account); }else{
                  echo $row->mac;
                  } ?></a></td>
                ...
                <td class="text-center">
                  ...
                  <?php echo form_open('reseller/users/renewOneMonth/'.$row->account,array('class'=>'form-horizontal'));?>
                ...
                <td class="text-center">
                  <?=user_action_buttons($row->account, 'reseller');?>
                </td>
              </tr>
              <?php endforeach;?>
            </tbody>
